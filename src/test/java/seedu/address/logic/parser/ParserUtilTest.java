...
public class ParserUtilTest {
    ...
    /*@Test
    public void parseSkill_collectionWithInvalidTags_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseSkill(Arrays.asList(VALID_TAG_1, INVALID_TAG)));
    }

    @Test
    public void parseSkill_emptyCollection_returnsEmptySet() throws Exception {
        assertTrue(ParserUtil.parseSkill(Collections.emptyList()).isEmpty());
    }

    @Test
    public void parseSkill_collectionWithValidTags_returnsTagSet() throws Exception {
