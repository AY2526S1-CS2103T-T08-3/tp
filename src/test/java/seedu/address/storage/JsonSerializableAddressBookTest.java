...
public class JsonSerializableAddressBookTest {
    ...
    //     // Disabled for now — legacy JSON structure differs from current Person model
    //     JsonSerializableAddressBook dataFromFile = JsonUtil
    //             .readJsonFile(TYPICAL_PERSONS_FILE, JsonSerializableAddressBook.class)
    //             .orElseThrow(() -> new AssertionError("Missing test data: " + TYPICAL_PERSONS_FILE));
    ...
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil
                .readJsonFile(INVALID_PERSON_FILE, JsonSerializableAddressBook.class)
                .orElseThrow(() -> new AssertionError("Missing test data: " + INVALID_PERSON_FILE));
    ...
    public void toModelType_duplicatePersons_throwsIllegalValueException() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil
                .readJsonFile(DUPLICATE_PERSON_FILE, JsonSerializableAddressBook.class)
                .orElseThrow(() -> new AssertionError("Missing test data: " + DUPLICATE_PERSON_FILE));
